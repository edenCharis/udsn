...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="scolarité"){
    ...
    if(isset($_GET["voir"])){
        ...
        header("location: h?specialite=$spec&semestre=$semestre&examen=$examen&niveau=$niveau&annee=$annee&etablissement=".$_SESSION["etablissement"]);
                ...
                <div class="col-md-12 text-center">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">  <a href="note" class="btn btn-sm btn-primary"> <i class="la la-edit"></i>note de service</a> </h4>
                            </div>
                            <div class="card-body">
