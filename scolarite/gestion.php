				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="../scolarite/gestion">demandes</a></li>
										...
										<div class="table-responsive">
											<table id="example3" class="display" style="min-width: 845px">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql ="select * from demande where etab='".$_SESSION['etablissement']."' and statut_soumission";

                                                                                                
                                                
                                                  $resultat=$connexion->query($sql);
                                                  if($resultat){
                                                  while($demande = $resultat->fetch_object()){
                                                ?>
													<tr>
														<td><strong><?php echo $demande->code;?></strong></td>
														<td><?php echo getNomByInscription($demande->etudiant,$connexion); ?></td>
														<td><?php echo $demande->date_demande; ?></td>
														<td><?php echo $demande->specialite;?></td>
                                                        <td><?php echo $demande->parcours;?></td>
                                                        <td><?php echo $demande->diplome;?></td>
                                                     
                                                        <td><?php echo ($demande->statut_soumission == 1 ? "Acceptée" : "Rejetée"); ?></td>
                                                        <td><?php echo ($demande->statut == 1 ? "Delivrée" : "Non Delivrée"); ?></td>
                                                        
                                                        <td><?php echo $demande->annee_univ; ?></td>
                                                        <td>
                                                        ...
                                                        <a href="editer?code=<?php echo $demande->code;?>" class="btn btn-sm btn-info"><i class="la la-edit"></i>Editer</a>
                                                        <a href="gestion?sup=<?php echo $demande->code;?>" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i>supprimer</a>
															<?php }else{ echo "//";}?>
														</td>												
													</tr>
<?php }?>
