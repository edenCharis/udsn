					...
					<div class="col-lg-12">
						<div class="card">
                            ...
                            <?php 
                              ...
                              {
                            ?>
                              <h4> Classe : <?php echo $_SESSION['classe'];?></h4>
                              <?php }?>
                              <?php 
                              if(isset($_SESSION["ecue"]))
                              {
                            ?>
                              <h4> Ecue : <?php echo $_SESSION['ecue'];?></h4>
                              <?php }?>
...
<div class="modal fade bd-example-modal-lg" id="typeAgentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel">Formulaire d'anonymation d'une copie d'examen</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <form id="typeAgentForm" method="post" action="traitement1">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select  id="single-select"  class="disabling-options"class="form-control form-control-lg" name="ecue" recquired>
                                                <option selected=""></option>
                                               <?php 
