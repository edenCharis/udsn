									...
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="email" class="form-control" name="email"  placeholder="<?php echo isset($_SESSION["email"]) ? $_SESSION["email"]: "John@gmail.com"?>">
											</div>
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="date"  class="form-control" id="dateOfBirth"  name="datenaissance"  min="">
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="form-group">
												<label class="form-label">Lieu de naissance</label>
						                      	<input type="text"  class="form-control" id="lieunaissance"  name="lieunaissance"  min="">
										</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="number"   oninput="updateMention()" id="moyenne" class="form-control" name="moybac"  min="10" step="0.01" max="20" >
											</div>
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												<label  for="anneeSelect"  class="form-label">Année d'obtention</label>
												<select id="anneeSelect" class="form-control disabling-options" name="anneebac" >
												    <option value=""></option>
												</select>
											</div>
										</div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<select  id="mention" class="form-control disabling-options" name="mention" >
...
<div class="modal" id="messageModal" tabindex="-1" role="dialog" aria-labelledby="messageModalLabel" aria-hidden="true">
    ...
    ***********************************-->
    ...
    for (var annee = 2015; annee <= 2030; annee++) {
...
<script>
	...
	<script>
        function updateMention() {
            ...
            // Logique pour attribuer la mention
