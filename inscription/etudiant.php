...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="inscription"){
              ...
              if(isset($_GET['sup']))
              {
                  ...
                  if($connexion->query($sql)){
                    header("location: ../inscription/etudiant");
                    exit;
              }}
            ...
            <div class="container-fluid">
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="../inscription/">Scolarité</a></li>
                            <li class="breadcrumb-item active"><a href="../inscription/donnees">Données</a></li>
					...
					<div class="col-lg-12">
						<div class="card">
                            ...
                            <div class="basic-form">
                                    <form method="post" action="impression.php" id="form-recherche">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                            <select id="specialite" class="" name="specialite" >
                                                <option selected=""></option>
                                               <?php 
                                            ...
                                            <div class="form-check form-check-inline">
                                             ...
                                             <div class="form-check form-check-inline">
                                                <label class="form-check-label">
                                                  ...
                                                  <a href="index" class="btn btn-sm btn-success">
										...
										<tbody>
                                          ...
                                          <?php 
                                           ...
                                           $specialites= array();
                                                 ...
                                                 if(isset($_GET["specialite"]) and in_array($_GET["specialite"],$specialites)){
                                                     
                                                     $sql=$sql." and classe in (select libelle from classe where specialite='".$_GET["specialite"]."')";
                                                 }
                                                 
                                                  if(isset($_GET["annee"]) and in_array($_GET["annee"],$annees)){
                                          ...
                                          ?>
											<tr>
                                                ...
                                                <td><?php  $code=getCandidatCodeByInscription($etudiant['id'],$connexion); echo $code;?></td>
                                                ...
                                                <td><?php  $spec=obtenirSpecialiteClasse($etudiant['classe'],$connexion); echo $spec?></td>	
                                                <td><?php echo $etudiant['annee'];?></td>	
                                                
												<td>

                                                 <a href="modifier?code=<?php echo $code;?>&annee=<?php echo $etudiant["annee"]; ?>&specialite=<?php echo $spec;?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i>Modifier</a>
...
<script>
	...
	<script>
    // Fonction pour soumettre le formulaire d'impression
    function submitPrintForm() {
        // Récupérer les valeurs du formulaire de recherche
        var specialite = document.getElementById('specialite').value;
        var annee = document.getElementById('annee').value;

        // Remplir les champs cachés du formulaire d'impression
        document.getElementById('specialite-impression').value = specialite;
        document.getElementById('annee-impression').value = annee;

        // Soumettre le formulaire POST pour l'impression
