...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="pvd"){
    ...
    if( isset($_GET["generer"])){
        ...
        $niveau = NiveauParSemestre($semestre);
         ...
         $_SESSION["lien"]="www.udsn.pro/proces?spec=$spec&semestre=$semestre&examen=$examen&niveau=$niveau&annee=$annee&etablissement=".$_SESSION["etablissement"];

        header("location: pvd?sucess=Le lien d'accès a été crée");
    ...
    if(isset($_GET["voir"])){
        ...
        header("location: proces?specialite=$spec&semestre=$semestre&examen=$examen&niveau=$niveau&annee=$annee&classe=$classe&etablissement=".$_SESSION["etablissement"]);
                                    ...
                                    <form method="get">
                                        ...
                                        <div class="form-row">
                                             ...
                                             <div class="form-group col-sm-2">
                                               ...
                                               <?php 
                                                        $sql="select * from classe where   specialite in ( select libelle from specialite where parcours='$parcours')";
                                            ...
                                            <div class="form-group col-sm-2">
                                                ...
                                                <select   class="disabling-options"  name="specialite" recquired>
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from specialite where etab='".$_SESSION['lib_etab']."' and parcours='$parcours'";
                                                        $resultat=$connexion->query($sql);
                                                        while($etablissement =$resultat->fetch_assoc()){
                                                ?>
                                                 <option><?php echo str_replace("+","'",$etablissement['libelle']);?></option>
                                            ...
                                            <div class="form-group col-sm-2">
                                                ...
                                                <option  value="<?php echo $examen?>"selected=""> <?php  echo ($examen == "ordinaire") ? "Session ordinaire" : "Session de rattrapage" ;?></option>
                                            ...
                                            <div class="form-group col-sm-2">
                                                ...
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from semestre where libelle='$semestre'";
                                                        $resultat=$connexion->query($sql);
                                                        while($etablissement =$resultat->fetch_assoc()){
                                                ?>
                                                 <option><?php echo str_replace("+","'",$etablissement['libelle']);?></option>
                                            ...
                                            <select  class="disabling-options" class="form-control form-control-lg" name="annee" recquired>
                                                ...
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from annee where libelle='$annee'";
                                                        $resultat=$connexion->query($sql);
                                                        while($etablissement =$resultat->fetch_assoc()){
                                                ?>
                                                 <option><?php echo str_replace("+","'",$etablissement['libelle']);?></option>
                                        ...
                                        <button type="submit" class="btn btn-info" name="generer"><i class="la la-cog"></i>Lien d'accès</button>
                                        <button type="submit" class="btn btn-success" name="voir"><i class="la la-eye"></i>Consulter</button>
                                    </form>
