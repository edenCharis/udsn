...
<table id="example3" class="display" >
    ...
    ?>
        ...
        <tr>
         ...
         ?>
            <th class="small-column">  <?php   if($a < 10  and $a !== "##") { ?> <form id="myForm"  action="traitement5" method="post"> <input type="hidden" name="ecue" value="<?php echo $ecue->libelle;?>"><input type="hidden" name="ue" value="<?php echo $data->libelle;?>"> <input type="hidden" name="etudiant" value="<?php echo $etudiant->id;?>"> <input type="number" step="0.25" max="20" min="0" name="note" id="numericInput" value="<?php echo ($a !== "##") ? $a : "#" ;?>"> <input type="submit" name="send" style="display: none;"></form><?php }else{  echo ($a !== "##") ? $a : "#" ;}?></th>
            <th class="small-column text-danger"> <?php   if($b < 10  and $a !== "##" ) { ?> <?php echo ($b !== "##") ? $b: "#";?><?php }else{  echo ($b !== "##") ? $b: "#" ; } ?> </th>
