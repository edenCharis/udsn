								...
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          ...
                                          <?php 
                                                 $sql ="select * from ligne2 where classe in ( select classe from repartition_enseignant where code='".$_SESSION["code_enseignant"]."') and annee in ( select annee from repartition_enseignant where code='".$_SESSION["code_enseignant"]."') and user_id=".$_SESSION["id_user"];
                ...
                <form id="typeAgentForm" method="post" action="traitement1">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select  class="disabling-options"  name="etudiant" required>
                                               ...
                                               <?php 
                                                        $sql="select * from inscription where classe in ( select classe from repartition_enseignant where code='".$_SESSION["code_enseignant"]."')";
                                                        $resultat=$connexion->query($sql);
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select   id="classe"   class="disabling-options" class="form-control form-control-lg" name="classe" recquired>
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from classe where  libelle in ( select classe from repartition_enseignant where code='".$_SESSION["code_enseignant"]."')";
                                                        $resultat=$connexion->query($sql);
