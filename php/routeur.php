...
if(isset($_POST['username']) and isset($_POST['password'])){
    ...
    $query = "SELECT id,nom,login, role,mdp,etab,univ,img,classe,ecue,parcours,annee,semestre,examen,code_enseignant FROM utilisateur WHERE login = ? AND mdp = ?";
    $stmt = $connexion->prepare($query);
    $stmt->bind_param("ss", $username, $password);
    $stmt->execute();
    $stmt->bind_result($id,$nom,$userName, $userRole,$mdp,$etablissement,$univ,$img,$classe,$ecue,$parcours,$annee,$semestre,$examen,$code_enseignant);
    $stmt->fetch();
    $stmt->close();
