...
if( $_SESSION['id'] == session_id() and  $_SESSION['role']=="enseignant"){
    ...
    if(isset($_GET['sup'])){
        ...
        if($connexion->query($sql)){
               ...
               if($id_notation !== null){
                  ...
                  if($nouvelleNote !== null)
                  {
                    $sql1="UPDATE notation set moyDev=$nouvelleNote where id=$id_notation";
                        ...
                        $sql1="UPDATE notation set moyDev=NULL,user_id=".$_SESSION["id_user"]." where id=$id_notation";
                     }

                  if($connexion->query($sql1)){
                    
                        header("location: notation2?classe=$classe&annee=$annee&sucess=supression effectuée avec success");
                  }else{
                    header("location: notation2?classe=$classe&annee=$annee&erreur=$connexion->error $nouvelleNote" );
                               }

                 
               }else{
                header("location: notation2?classe=$classe&annee=$annee&erreur=Erreur veuillez ressayez !" );
               }
            ...
            header("location: notation2?classe=$classe&annee=$annee&erreur=$connexion->error" );
        }
    }
				...
				<div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="../enseignant/"><?php echo $classe;?></a></li>
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title">Classe : <?php echo $classe;?> 
								</h4>
									<h4 class="card-title">Année-Académique : <?php echo $annee;?> 
								</h4>
								...
								<div class="table-responsive">
									<table id="example3" class="display" style="min-width: 845px">
										...
										<tbody>
                                          ...
                                          <?php 
                                                 $sql ="select * from ligne2 where classe in ( select classe from repartition_enseignant where code='".$_SESSION["code_enseignant"]."') and classe='$classe'  and annee='$annee' and user_id=".$_SESSION["id_user"];
                ...
                <form id="typeAgentForm" method="post" action="traitement1">
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select  class="disabling-options"  name="etudiant" required>
                                               ...
                                               <?php 
                                                        $sql="select * from inscription where classe='$classe' and annee='$annee'";
                                                        $resultat=$connexion->query($sql);
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select   id="classe"   class="disabling-options" class="form-control form-control-lg" name="classe" recquired>
                                                <option selected=""></option>
                                               <?php 
                                                        $sql="select * from classe where  libelle='$classe'";
                                                        $resultat=$connexion->query($sql);
                    ...
                    <div class="input-group mb-3">
                                            ...
                                            <select    class="disabling-options"class="form-control form-control-lg" name="ecue" recquired >
                                                <option selected=""></option>
                                               <?php 
