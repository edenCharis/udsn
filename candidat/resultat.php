...
if ($_SERVER["REQUEST_METHOD"] == "POST" and isset($_POST["matricule"]) and isset($_POST["annee"])) {
...
if( getIdInscription($matricule,$annee,$connexion) !== null)
{
    ...
    header("location: resultat?erreur=Erreur ! Votre matricule est erroné ");
    exit;
    ...
    if( !verifierClasseEtudiant($etudiant,$classe,$annee,$connexion,$etablissement)){
        header("location: resultat?erreur=Erreur ! Votre classe saisie ne correspond pas.");
        exit;
    }
    ...
    if( !isSpecialiteInEtablissement($connexion,getSpecialiteClasse($connexion,$classe),$etab)){
        header("location: resultat?erreur=la classe choisie ne correspond pas à l'etablissement.");
        exit;
    }

    if( !verifierEntree($connexion,$etudiant,$semestre,$examen,$annee,$etablissement)){
        header("location: resultat?erreur=les resultats ne sont pas encore disponibles.");
        exit;
    }

        logUserAction($connexion,$_SESSION['id_user'],"Accès aux resulats par l'etudiant $id, $semestre, $anneee, $examen",date("Y-m-d H:i:s"),$userIP,"utilisateur:$utilisateur");
        header("location: voir?etudiant=$etudiant&semestre=$semestre&annee=$annee&examen=$examen&etablissement=$etablissement");
				...
				<div class="row">
					<div class="col-xl-12 col-xxl-12 col-sm-12">
                        <div class="card">
							...
							<div class="card-body">
                                <form action="resultat" method="post" enctype="multipart/form-data">
									<div class="row">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<select class="disabling-options"  name="examen" required>
                                                <option value=""></option>
										...
										<div class="col-lg-8 col-md-8 col-sm-8">
											<button type="submit" class="btn btn-lg btn-success"> <i class="la la-send"></i> Envoyer</button>
